...
function createWeatherMood(weatherDescription){
  ...
  //     backgroundAnimator.innerHTML = `<div class="generic-cloud cloud-1"></div>
  //     <div class="generic-cloud cloud-2"></div>
  //     <div class="generic-cloud cloud-3"></div>`;
  //     break;
  // }
  ...
  if(weatherDescription == '01n' || weatherDescription == '01d'){
    ...
    <div class="generic-cloud cloud-2"></div>
    <div class="generic-cloud cloud-3"></div>
    <div class="generic-cloud cloud-4"></div>
    <div class="generic-cloud cloud-5"></div>
    <div class="generic-cloud cloud-6"></div>
    <div class="generic-cloud cloud-7"></div>
    <div class="generic-cloud cloud-8"></div>`;
    ...
    backgroundAnimator.innerHTML = `<div class="generic-cloud cloud-2"></div>
    <div class="snow">
        <div></div>
    </div>`;
